...
### 如何使用 Zotero 生成 `.bib` 文件

Zotero 是一款强大的文献管理工具，能帮你轻松收集、整理和引用参考文献。接下来，我们一步步教你**如何使用 Zotero 生成 `.bib` 文件**，然后在论文中愉快地引用文献。
...
2. **导出为 `.bib` 文件：**
    ...
    - 勾选 **“仅导出选定的条目”**，然后点击 **确定**。
    - 选择保存位置，保存文件名为 `reference.bib`，点击 **保存**。
3. **批量导出整个文献库：**  
